...
#e.g.  plot [0:0.8][0:0.8]"CIEpoints_overxy_d0p0025_Y1p0_g0p454545.txt" u 1:2:10 w points pt 5 lc rgb variable
#
#usage:
...
#
#edited by Dale Kelly for u'v' chromaticities
#calculations from http://en.wikipedia.org/wiki/CIELUV 
BEGIN{
if (d=="") {d=0.01}
if (Y=="") {Y=1.0}
...
outf="CIEpoints_overuv_d"ds"_Y"Ys"_g"gs".txt"
